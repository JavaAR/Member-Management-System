...
layui.config({
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							...
							'<div class="admin-header-lock-name" id="lockUserName">DBDCLUB</div>'+
							'<div class="input_btn">'+
	...
	function showNotice(){
		layer.open({
	        ...
	        btn: ['火速围观'],
	        moveType: 1,	
	        content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>高级bug编写工程师@AR</p></div>',
